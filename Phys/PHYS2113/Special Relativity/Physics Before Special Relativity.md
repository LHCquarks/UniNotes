...
I also don't know. Ill ask the lecturer

Inertial frames of reference are ones where newton's first law holds: `An object will remain at the same velocity unless acted on by an external force`.  Where external forces are any 'real' force eg: gravity, friction ect.
### Aside: what is a real force

IDK, ill ask the lecturer

There are many forces in nature and for all we can categorizes them as 'fictitious' and 'real' forces. Whist real forces appear in all frames of refer
## Maxwell's equations
Maxwell's equations produced an oddity with EM waves. His equations stated
$$
\begin{align}
